          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Déconnexion
              </button>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
              <div className="flex items-start justify-between mb-8">
                ...
                <div className={`w-20 h-20 bg-gradient-to-r ${getRoleColor(session.user?.role || '')} rounded-2xl flex items-center justify-center shadow-lg`}>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className={`w-12 h-12 bg-gradient-to-r ${getRoleColor(session.user?.role || '')} rounded-xl flex items-center justify-center`}>
